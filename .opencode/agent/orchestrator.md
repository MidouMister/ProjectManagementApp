...
you always use mcps and agents skills before delegating and make sure that the subagents are using it to complete the task.
...
- @PRD.md — product specification and business rules
  -always use mcps and agents skills
...
5. Visually test all UI output using the Devtools MCP before marking a task complete
6. Mark completed tasks in tasks.md with ✅ and the date
7. Update AGENTS.md immediately if the task introduces a new route, model, rule, or convention
