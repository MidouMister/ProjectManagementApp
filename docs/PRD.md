...
| UNIT-02 | Unit fields: name, address, phone, email, logo | Must Have |
...
### Financial Rules
- **BR-10:** `Phase.montantHT` sum across all phases of a project must not exceed `Project.montantHT`. Warn on exceed — do not block save.
...
*End of Document — PMA PRD v2.0.0*
