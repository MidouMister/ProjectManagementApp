        ...
        >
          ...
          <div className="mb-6">
            {(() => {
              ...
              if (user?.role === "OWNER" && user?.Company?.id) {
                logoHref = `/company/${user.Company.id}`;
              } else if (user?.role === "ADMIN" && user?.Unit?.id) {
                logoHref = `/unite/${user.Unit.id}`;
              } else if (user?.role === "USER" && user?.id) {
                logoHref = `/user/${user.id}`;
              }
              ...
              const LogoContent = (
                <AspectRatio
                  ...
                  className={clsx(
                    ...
                    { "hover:opacity-80 cursor-pointer": !!logoHref }
                  )}
                >
